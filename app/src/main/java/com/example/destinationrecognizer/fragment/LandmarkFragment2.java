...
public class LandmarkFragment2 extends Fragment {
    private List<LandmarkModel> landmarks;
    private View rootView;
    CustomMapView mMapView;
    private GoogleMap googleMap;

    public LandmarkFragment2() {
    }

    public static LandmarkFragment2 newInstance() {
        LandmarkFragment2 fragment = new LandmarkFragment2();
        return fragment;
    }
